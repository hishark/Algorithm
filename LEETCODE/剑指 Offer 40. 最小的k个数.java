...
// 堆
// ref: https://leetcode-cn.com/problems/zui-xiao-de-kge-shu-lcof/solution/zui-xiao-de-kge-shu-by-leetcode-solution/
class Solution {
    public int[] getLeastNumbers(int[] arr, int k) {
        // 数组中最小的 k 个数
        int[] ans = new int[k];
         ...
         * 
         *  遍历数组的时候，若堆的大小小于 k，就直接把数字放进去
         *  若堆的大小已经为 k，需要判断当前数字和堆顶数字的大小：
